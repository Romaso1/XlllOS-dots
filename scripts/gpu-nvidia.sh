...
sudo pacman -Syu --needed --noconfirm nvidia-utils lib32-nvidia-utils nvidia-settings opencl-nvidia lib32-opencl-nvidia libva-nvidia-driver vulkan-icd-loader lib32-vulkan-icd-loader mesa-utils vulkan-tools
