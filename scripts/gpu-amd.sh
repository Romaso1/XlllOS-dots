...
sudo pacman -Rns --noconfirm     amdvlk lib32-amdvlk     vulkan-amdgpu-pro amf-amdgpu-pro opencl-amd rocm-opencl-runtime     2>/dev/null || true

echo "[GPU/AMD] Installing AMD Mesa/RADV packages..."
sudo pacman -Syu --needed --noconfirm     mesa lib32-mesa     vulkan-radeon lib32-vulkan-radeon     libva-mesa-driver lib32-libva-mesa-driver     mesa-vdpau lib32-mesa-vdpau     vulkan-icd-loader lib32-vulkan-icd-loader     mesa-utils vulkan-tools     xf86-video-amdgpu
